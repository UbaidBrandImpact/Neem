package com.example.bim.neem.Utils;
...
public class MLRoundedImageView extends ImageView {
    ...
    private static final String TAG = MLRoundedImageView.class.getSimpleName();
    ...
    public MLRoundedImageView(Context context, AttributeSet attrs, int defStyleAttr) {
